...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url()."/public/" ?>css/buttons.bootstrap4.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="<?= base_url()."/public/" ?>img/logo.png" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">BV La Salle</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Jose Luis Pimentel Z.</a>
        </div>
      </div>
